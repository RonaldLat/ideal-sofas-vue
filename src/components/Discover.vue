...
<h2 class="my-8 text-5xl text-center font-niccone">Dicover More</h2>
  <div class="grid w-full gap-7 md:grid-cols-6 md:grid-rows-2 ">
    ...
    <img class="w-full h-auto col-span-2" src="/discover/e-catalog.jpg" alt="" />
    <img class="w-full h-auto col-span-3 col-start-1" src="/discover/marble.jpg" alt="" />
    <img class="w-full h-auto col-span-3" src="/discover/select.jpg" alt="" />
  </div>
</template>
